...
HD_PWD='C:/Users/elena/OneDrive/Desktop/facultate/an3/ssc/proiect/CacheOrganizationv3/CacheOrganizationv3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log topenv.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source topenv.tcl -notrace
