...
HD_PWD='C:/Users/elena/OneDrive/Desktop/facultate/an3/ssc/proiect/CacheOrganizationv3/CacheOrganizationv3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log topenv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source topenv.tcl
